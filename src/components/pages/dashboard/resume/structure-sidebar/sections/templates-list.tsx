            ...
            {allTemplates?.map((template) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  <div
                    className="absolute text-sm inset-0 w-full h-full flex flex-col
                   font-bold font-title capitalize items-center justify-end p2 bg-gradient-to-t from-background"
                  >
                    {template}
                  </div>
                </button>
